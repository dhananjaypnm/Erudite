...
public class PulseRateFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_pulse_rate, container, false);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        RecyclerView recyclerView= (RecyclerView) view.findViewById(R.id.pulse_rate_recycler_view);
