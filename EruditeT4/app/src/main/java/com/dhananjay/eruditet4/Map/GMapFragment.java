...
public class GMapFragment extends Fragment implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener ,LocationListener{
    ...
    public void onLocationChanged(Location location) {
        ...
        Button hospitals= (Button) view.findViewById(R.id.car_service);
        ...
        Button doctors= (Button) view.findViewById(R.id.gas_station);
        ...
        Button pharmacies= (Button) view.findViewById(R.id.parking);
    ...
    private void getNearbyPlaces(String type) {
        ...
        call.enqueue(new Callback<ResponseObject>() {
            ...
            public void onResponse(Call<ResponseObject> call, Response<ResponseObject> response) {
                ...
                CameraPosition target=CameraPosition.builder().target(new LatLng(lastLocation.getLatitude(),lastLocation.getLongitude())).zoom(14).build();
                googleMap.animateCamera(CameraUpdateFactory.newCameraPosition(target));
            }
